...
import '../xelauikit/xela_alert.dart';
              ...
              Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                          child: Text("Alert", style: XelaTextStyle.XelaSubheadline.apply(color: _isDark ? XelaColor.Gray11 : XelaColor.Gray2),)
                      ),
                    ],
                  )
              ),
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: XelaAlert(
                          ...
                          leftIcon: Icon(Icons.gpp_maybe, size: 20, color: _isDark ? XelaColor.Green10 : XelaColor.Green2),
                          primaryColor: _isDark ? XelaColor.Green10 : XelaColor.Green2,
                          secondaryColor: _isDark ? XelaColor.Gray11 : XelaColor.Gray7,
                          background: _isDark ? XelaColor.Green1 : XelaColor.Green12,
                        ),
                      ),
                      ...
                      Padding(
                        ...
                        child: XelaAlert(
                          title: "Warning!",
                          text: "Careful! please, never look behind... i said NEVER!",
                          primaryColor: _isDark ? XelaColor.Orange6 : XelaColor.Orange3,
                          secondaryColor: _isDark ? XelaColor.Gray7 : XelaColor.Gray7,
                      ...
                      Padding(
                        ...
                        child: XelaAlert(
                          title: "Alert title",
                          text: "Alert text",
                          leftIcon: Icon(Icons.grid_view, size: 20, color: _isDark ? XelaColor.Blue6 : XelaColor.Blue6),
                          primaryColor: _isDark ? XelaColor.Blue6 : XelaColor.Blue6,
                          secondaryColor: _isDark ? XelaColor.Gray11 : XelaColor.Gray7,
                          background: _isDark ? XelaColor.Gray3 : XelaColor.Gray12,
                          rightWidget: InkWell(onTap: (){},child: Icon(Icons.grid_view, size: 20, color: _isDark ? XelaColor.Gray6 : XelaColor.Gray6),),
                        ),
                      ),
                      ...
                      Padding(
                        ...
                        child: XelaAlert(
                          title: "Alert title",
                          text: "Alert text",
                          leftIcon: Icon(Icons.grid_view, size: 20, color: _isDark ? XelaColor.Orange6 : XelaColor.Orange3),
                          primaryColor: _isDark ? XelaColor.Orange6 : XelaColor.Orange3,
                          secondaryColor: _isDark ? XelaColor.Gray11 : XelaColor.Gray7,
                          background: _isDark ? XelaColor.Gray3 : XelaColor.Gray12,
                        ),
                      ...
                      Padding(
                        ...
                        child: XelaAlert(
                          title: "Alert title",
                          text: "Alert text",
                          primaryColor: _isDark ? XelaColor.Green2 : XelaColor.Green2,
                          secondaryColor: _isDark ? XelaColor.Gray11 : XelaColor.Gray7,
                          background: _isDark ? XelaColor.Gray3 : XelaColor.Gray12,
                        ),
                      ),
